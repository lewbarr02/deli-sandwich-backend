...
function createEditablePopup(row, marker, index) {
  ...
  popup.innerHTML =
    ...
    "<input id='editType' style='width:100%; margin-bottom:5px;' value='" + (row['Type'] || "") + "'/><br>" +
    "<label style='font-weight:bold;'>Status:</label><br>" +
    "<input id='editStatus' style='width:100%; margin-bottom:5px;' value='" + (row['Status'] || "") + "'/><br>" +
    "<label style='font-weight:bold;'>Notes:</label><br>" +
    "<textarea id='editNotes' rows='4' style='width:100%; margin-bottom:5px;'>" + (row['Notes'] || "") + "</textarea><br>" +
    "<label style='font-weight:bold;'>Website:</label><br>" +
    "<input id='editWebsite' style='width:100%; margin-bottom:5px;' value='" + (row['Website'] || "") + "'/><br>" +
    "<label style='font-weight:bold;'>Net New:</label><br>" +
    "<input id='editNetNew' style='width:100%; margin-bottom:5px;' value='" + (row['Net New'] || "") + "'/><br>" +
    "<label style='font-weight:bold;'>Size:</label><br>" +
    "<input id='editSize' style='width:100%; margin-bottom:5px;' value='" + (row['Size'] || "") + "'/><br>" +
    "<label style='font-weight:bold;'>ARR:</label><br>" +
    "<input id='editARR' style='width:100%; margin-bottom:5px;' value='" + (row['ARR'] || "") + "'/><br>" +
    "<label style='font-weight:bold;'>Obstacle:</label><br>" +
    "<input id='editObstacle' style='width:100%; margin-bottom:5px;' value='" + (row['Obstacle'] || "") + "'/><br>" +
    "<label style='font-weight:bold;'>Self Sourced:</label><br>" +
    "<input id='editSelfSourced' style='width:100%; margin-bottom:10px;' value='" + (row['Self Sourced'] || "") + "'/><br>" +
    "<button onclick='submitEdits(" + index + ", this)' style='padding:4px 10px;'>Save</button>";
  return popup;
}
